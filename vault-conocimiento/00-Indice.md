---
tags: [arnes, investigacion, moc, indice]
---

# Índice — Base de conocimiento del arnés empresarial

Esta bóveda de Obsidian sintetiza la investigación de los objetivos específicos 1-4 de la propuesta de pasantía y cumple el **objetivo específico 5**: crear una base de conocimiento en Obsidian con el resultado de esa investigación y dejarla disponible a los modelos a través de Graphify.
...
Estas notas son SÍNTESIS para navegación rápida, no copias de la investigación cruda (que sigue viviendo en `docs/Investigacion Pre-proyecto/` y `docs/ARC42_Harness_Empresarial.md`). Graphify indexa esta bóveda junto al resto del repo para que los modelos puedan consultarla vía `graphify query`.
